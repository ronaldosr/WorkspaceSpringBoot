package br.com.ronaldosr.security.jwt;
...
public class JwtTokenProvider {
	...
	public Authentication getAuthentication(String token) {
		UserDetails userDetais = this.userDetailsService.loadUserByUsername(getUsername(token));
		return new UsernamePasswordAuthenticationToken(userDetais, "", userDetais.getAuthorities());
	}
